...
const sampleCommand = {
    ...
    "properties": {
        ...
        "description": "Shows gif where you hugs somebody",
        "format": "hug [@user]"      
    },
    ...
    _Command(msg, args){
        ...
        axios.get('https://api.tenor.com/v1/search?nothing&q=anime-hug&key=27T9K6KM7H2L&limit=10')
            .then(response => {
                ...
                msg.channel.send("**" + kissed + "**, you have been hugged by **" + msg.author.username + "**", Embed);
